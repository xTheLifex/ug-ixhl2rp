...
ix.anim.SetModelClass("models/vortigaunt_rp/vortigaunt.mdl", "vortigaunt")
...
ix.config.Add("VortHealMin", 30, "Minimum health value that can be healed by vortigaunt" , nil, {
	data = {min = 1, max = 100},
	category = "Vortigaunt Healing Swep"
})

ix.config.Add("VortHealMax", 40, "Maximum health value that can be healed by vortigaunt" , nil, {
	data = {min = 1, max = 100},
	category = "Vortigaunt Healing Swep"
})
